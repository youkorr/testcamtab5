...
bool Tab5Camera::init_csi_interface_() {
  ...
  // CORRECTION: Utiliser les valeurs numériques directement
  // CAM_CTLR_COLOR_RAW8 = 0, CAM_CTLR_COLOR_RGB565 = 3
  csi_config.input_data_color_type = (cam_ctlr_color_t)0;  // RAW8
  csi_config.output_data_color_type = (cam_ctlr_color_t)3; // RGB565
