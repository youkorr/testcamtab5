...
static const sc202cs_reginfo_t init_reglist_1280x720_30fps[] = {
    ...
    {0x337c, 0x02},          {0x337d, 0x0a},//{0x337d, 0x0a},
    ...
    {0x3e00, 0x00},          {0x3e01, 0x4d},//{0x3e00, 0x00},{0x3e01, 0x4d}
    {0x3e02, 0xc0},          {0x3e09, 0x00},//{0x3e09, 0x00},
    {0x4509, 0x28},          {0x450d, 0x61},
    {0x450d, 0x61},          {0x320e, 0x04},  // 30FPS{0x320E, 0x04},
    {0x3221, 0x03},          {0x320c, 0x07},
    {0x5000, 0x20},          // Enable image processing
    {0x5001, 0xFF},          // Contrast (0x00=normal, 0x80=contrast moyen, 0xFF=max)
...
bool Tab5Camera::init_isp_() {
  ...
  int bayer_pattern = 1;  // RGGB - testez 0, 1, 2, 3
