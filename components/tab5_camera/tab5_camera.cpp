...
// Configuration VGA 640x480 RAW8 - VRAIE résolution VGA avec windowing centré
static const sc202cs_reginfo_t init_reglist_640x480_30fps[] = {
    ...
    {0x3e02, 0xc0},          {0x3e09, 0x00},
    {0x4509, 0x28},          {0x450d, 0x61},
    // Windowing VGA 640x480 centré depuis résolution max 1280x720
    // Start X = (1280-640)/2 = 320 = 0x140
    // Start Y = (720-480)/2 = 120 = 0x78
    {0x3200, 0x01},          {0x3201, 0x40},  // Start X = 0x0140 (320)
    {0x3202, 0x00},          {0x3203, 0x78},  // Start Y = 0x0078 (120)
    ...
    // VTS/HTS pour 30fps
    {0x320c, 0x05},          {0x320d, 0x00},  // HTS = 1280
    {0x320e, 0x02},          {0x320f, 0xd0},  // VTS = 720
    // PAS de flip/mirror - orientation normale
    {0x3221, 0x00},
    {SC202CS_REG_END, 0x00},
};
